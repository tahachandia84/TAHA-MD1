...
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "   EMON-MD WhatsApp Bot Installer  "
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
...
if [ ! -f .env ]; then
  ...
  echo "# DB_URL=" >> .env
  echo ""
  echo "⚠️  Please edit /root/EMON-MD/.env with your settings"
  echo "   nano /root/EMON-MD/.env"
fi
...
echo ""
echo "Next steps:"
echo "  1. Edit your config: nano /root/EMON-MD/.env"
echo "  2. Start the bot:    cd /root/EMON-MD && pm2 start index.js --name emon-md"
echo "  3. View logs:        pm2 logs emon-md"
