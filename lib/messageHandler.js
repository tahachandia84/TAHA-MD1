...
async function handleMessages(sock, messageUpdate) {
    try {
        ...
        if (message.message?.buttonsResponseMessage) {
            ...
            if (buttonId === 'channel') {
                await sock.sendMessage(chatId, {
                    text: '*Join our Channel:*\n[https://whatsapp.com/channel/0029VbClzp2Fcow6Q6KCqu16](https://whatsapp.com/channel/0029VbClzp2Fcow6Q6KCqu16)'
                }, { quoted: message });
                return;
            }
                ...
                await sock.sendMessage(chatId, {
                    text: `*Support*\n\nhttps://whatsapp.com/channel/0029VbClzp2Fcow6Q6KCqu16`
                }, { quoted: message });
                return;
            }
        }
