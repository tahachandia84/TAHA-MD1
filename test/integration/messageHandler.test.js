...
vi.mock('../../config.js', () => ({ default: { ownerNumber: '8801309991724@s.whatsapp.net', prefixes: ['.'], botName: 'EMON BOT', botMode: 'public' } }));
...
describe('handleMessages', () => {
    ...
    it('sends error response when command handler throws', async () => {
        ...
        const msg = createMockMessage({ text: '.crashtest', isGroup: true, senderId: '8801309991724@s.whatsapp.net' });
        await handleMessages(sock, { messages: [msg], type: 'notify' });
